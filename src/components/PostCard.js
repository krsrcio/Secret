...
export function PostCard({ post, canManage, onOpen, onFavorite, onOpenProfile, onEdit, onDelete, styles, colors }) {
  ...
  return <View style={styles.card}>
    ...
    {!!post.imageUrl && <Pressable accessibilityLabel="Open post responses" onPress={onOpen}><Image source={{ uri: post.imageUrl }} style={styles.postImage} resizeMode="cover" /></Pressable>}
